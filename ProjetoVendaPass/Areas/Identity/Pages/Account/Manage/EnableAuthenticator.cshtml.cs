...
namespace ProjetoVendaPass.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Usuário com ID '{UserId}' ativou o 2FA com um aplicativo autenticador.", userId);

            StatusMessage = "Seu aplicativo autenticador foi verificado com sucesso.";
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("ProjetoVendaPass"), // ← nome do sistema atualizado
